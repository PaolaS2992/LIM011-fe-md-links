...
exports.mdLink3 = exports.arrLinksValidate = exports.mdLink2 = exports.mdLink1 = exports.isAbsolute = exports.arrLinks = exports.anchorHtml = exports.renderHtml = exports.arrMarkdown = void 0;
...
var arrLinksValidate = function arrLinksValidate(html, pathAbsolute, option) {
  if (option === true) {
...
var mdLink3 = function mdLink3(path, option) {
  return isAbsolute(path).then(function (pathAbsolute) {
    return arrMarkdown(pathAbsolute).then(function (docMd) {
      var newArray = [];
      var newMap = docMd.map(function (cadaMD) {
        return renderHtml(cadaMD).then(function (html) {
          return arrLinksValidate(html, pathAbsolute, option);
        });
      });
      return Promise.all(newMap).then(function (responseMap) {
        responseMap.forEach(function (respuesta) {
...
var ruta = './';
console.log(mdLink3(directorio, true).then(function (e) {
  return console.log('Respuesta final', e);
}));